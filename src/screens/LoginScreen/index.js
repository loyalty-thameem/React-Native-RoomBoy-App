...
//             // console.log('The Object key getUsername', getUserName[key]);
//             dataAra.push(getUserName[key]);
//         }
//     })
...
//             console.log('useEffect userNameData', JSON.stringify(userNameData));
...
//     let setDummyState=[];
//     let dv = userNameKey.length>0?(userNameKey.map(key=>(console.log(userNameFb[key])))):null;
//     console.log('dummystATE',setDummyState);
//     console.log('dummystATE dv======>',dv);
            ...
            <View style={styles.curveMainContainer}>
                ...
                {!ifSignIn ?
                    <TouchableOpacity style={styles.loginButtonContainer}
                        ...
                        {
                            hellodata === null ? <ActivityIndicator size={'large'} color="white" />
                                :
                                <Text style={styles.loginLabelText}>{"Login"}</Text>
                        }
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity style={styles.loginButtonContainer}
                        ...
                        {
                            hellodata === null ? <ActivityIndicator size={'large'} color="#00C0F0" />
                                :
                                <Text style={styles.loginLabelText}>{'Signup'}</Text>
                        }
                    </TouchableOpacity>
